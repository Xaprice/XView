...
namespace DrawTools
{
	...
	class DrawLine : DrawTools.DrawObject
	{
        ...
        public override void Draw(Graphics g, double zoomFactor = 1.0)
        {
            ...
            int x1 = (int)(Math.Round(startPoint.X * zoomFactor));
            int y1 = (int)(Math.Round(startPoint.Y * zoomFactor));
            int x2 = (int)(Math.Round(endPoint.X * zoomFactor));
            int y2 = (int)(Math.Round(endPoint.Y * zoomFactor));
