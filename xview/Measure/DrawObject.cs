...
namespace DrawTools
{
	...
	public abstract class DrawObject
	{
        ...
        /// </summary>
        /// <param name="g"></param>
        public virtual void Draw(Graphics g, double zoomFactor= 1.0)
        {
        }
        ...
        /// </summary>
        /// <param name="g"></param>
        public virtual void DrawTracker(Graphics g, double zoomFactor)
        {
            if ( ! Selected )
                return;
            ...
            {
                Rectangle handleRect = GetHandleRectangle(i);
                Rectangle transformedRect = new Rectangle(
                    (int)(Math.Round(handleRect.X * zoomFactor)),
                    (int)(Math.Round(handleRect.Y * zoomFactor)), handleRect.Width, handleRect.Height);
                g.FillRectangle(brush, transformedRect);
            }
        ...
        public virtual MeasureListItem GetMeasureListItem()
        {
            return null;
        }

        public static double CalcLenght(Point p1, Point p2)
        {
            double length = 0;
